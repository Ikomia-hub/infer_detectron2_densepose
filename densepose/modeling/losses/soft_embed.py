...
from infer_detectron2_densepose.densepose.data.meshes.catalog import MeshCatalog
from infer_detectron2_densepose.densepose.modeling.cse.utils import normalize_embeddings, squared_euclidean_distance_matrix
